      ...
      <div className="max-w-5xl mx-auto z-50 px-4 sm:px-6">
        <div className=" mt-10 p-14 text-black text-center	">
          ...
          <div className="flex flex-col md:flex-row">
            ...
            />
            <button className="bg-my-orange mt-4 md:mt-0 shadow text-white px-8 py-3 rounded-md hover:bg-opacity-75 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-my-orange">
              Subscribe
            </button>
          </div>
        </div>
