...
export function proxy(req: NextRequest) {
  ...
  if (
    ...
    console.log("[Proxy] Skipping proxy for static/api path");
    return NextResponse.next();
  }

  // Handle trailing slashes
  if (pathname.endsWith("/") && pathname !== "/") {
    console.log("[Proxy] Redirecting to remove trailing slash");
  ...
  console.log("[Proxy] Cookie locale:", cookieL);
  ...
  console.log("[Proxy] Has Hindi in path:", hasHindiInPath);
  console.log("[Proxy] Is Hindi cookie:", isHindiCookie);
  console.log("[Proxy] Final locale:", locale);
  ...
  if (someSettingIsInconsistent) {
    console.log("[Proxy] Redirecting due to inconsistent settings");
