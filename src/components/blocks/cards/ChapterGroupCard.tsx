...
export function ChapterGroupCard({
  ...
  return (
    <motion.div
      ...
      className="h-full"
    >
      <Card className={`h-full border-2 transition-all ${classes.bg} ${classes.border}`}>
        <CardHeader>
          <div className="mb-3 flex items-center justify-between">
            <div className={`inline-flex size-12 items-center justify-center rounded-lg ${classes.icon}`}>
              {icon}
            </div>
