...
export function EnhancedCharacterCard({
  ...
  const displayName = locale === "hi" && character.sanskritName 
    ...
    >
        ...
        {character.imageSrc && (
            ...
            {/* Badge on Image */}
              ...
              >
                <CardTitle className={`mb-0 font-bold leading-tight drop-shadow-2xl ${locale === "hi" ? "font-dev text-3xl" : "font-newsreader text-2xl"}`}>
                  {displayName}
              </CardTitle>
            </div>
          </div>
          ...
          {!character.imageSrc && (
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className={locale === "hi" ? "font-dev text-xl" : "font-newsreader text-xl"}>
                    {displayName}
                  </CardTitle>
                </div>
              </div>
        ...
        <DialogContent className="max-h-[95vh] max-w-4xl overflow-hidden p-0 sm:max-h-[90vh]">
          ...
          <div className="relative h-[85vh] w-full overflow-hidden sm:h-[80vh]">
            ...
            <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/95 via-black/70 to-transparent p-6">
              <h3 className={`mb-1 font-bold text-white drop-shadow-2xl ${locale === "hi" ? "font-dev text-4xl" : "font-newsreader text-3xl"}`}>
                {displayName}
              </h3>
